...
function setup() {
    ...
    appleMusicInfoHandler.repeat = function () {
        if (
            document
                ...
                .children[0].children[2].getAttribute("aria-checked") == "true"
        ) {
            //If icon matches repeat just this song
            if (
                document
                    .querySelector('[class*="playback-controls"]')
                    .children[0].children[2].children[0].children[0].getAttribute("d") ==
    ...
    appleMusicInfoHandler.shuffle = function () {
        if (
            document
                .querySelector('[class*="playback-controls"]')
                .children[0].children[0].getAttribute("aria-checked") == "true"
        ) {
            return 1;
        }
        return 0;
