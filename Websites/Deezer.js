...
function setup() {
    ...
    deezerInfoHandler.rating = function () {
        for (
            ...
            if (
                document.getElementsByClassName("track-actions")[0].children[0].children[i]
                    .children[0].children[0].tagName === "svg" &&
                document
                    .getElementsByClassName("track-actions")[0]
                    .children[0].children[i].children[0].children[0].className.baseVal.includes(
                        "love"
                    )
            ) {
                if (
        ...
        if (
            ...
            if (
                document
                    ...
                    .children[0].children[0].children[0].children[
                        childCount - 4
                    ].children[0].children[0].className.baseVal.includes("one")
            ) {
                return 2;
            }
            return 1;
    ...
    deezerEventHandler.toggleThumbsUp = function () {
        for (
            ...
            if (
                ...
                document
                    .getElementsByClassName("track-actions")[0]
                    .children[0].children[i].children[0].click();
            }
        }
    };
