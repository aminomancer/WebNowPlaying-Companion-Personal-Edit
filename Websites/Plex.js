...
function setup() {
  ...
  plexInfoHandler.repeat = function() {
    if (
      ...
      if (
        document
          .querySelector("*[class*=AudioVideoPlayerControls-buttonGroupCenter]")
          .children[0].children[0].className.includes("one")
      ) {
        return 2;
      }
      return 1;
  ...
  plexInfoHandler.shuffle = function() {
    if (
      document
        .querySelector("*[class*=AudioVideoPlayerControls-buttonGroupCenter]")
        .children[4].className.includes("Active")
    ) {
      return 1;
    }
    return 0;
  ...
  plexEventHandler.toggleThumbsUp = function() {
    ...
    if (
      document
        .querySelector("*[class*=StarRating-slider]")
        .children[1].children[0].getAttribute("aria-valuenow") == 5
    ) {
      rating = 3;
    }
  ...
  plexEventHandler.toggleThumbsDown = function() {
    ...
    if (
      document
        .querySelector("*[class*=StarRating-slider]")
        .children[1].children[0].getAttribute("aria-valuenow") == 1
    ) {
      rating = 3;
    }
    //So we click at star midpoint
