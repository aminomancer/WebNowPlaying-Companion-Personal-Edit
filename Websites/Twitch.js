...
function setup() {
  ...
  twitchInfoHandler.readyCheck = function () {
    return (
      document.getElementsByClassName("video-player__default-player").length > 0 &&
  ...
  twitchInfoHandler.rating = function () {
    if (
      document.getElementsByClassName("follow-btn__follow-btn")[0].className.includes("following")
    ) {
      return 5;
    }
    return 0;
