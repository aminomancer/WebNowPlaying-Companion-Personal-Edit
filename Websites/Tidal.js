...
function setup() {
    ...
    tidalInfoHandler.title = function () {
        return document.getElementById("footerPlayer").children[0].children[1].children[0]
            .children[0].innerText;
    };
    tidalInfoHandler.artist = function () {
        return document.getElementById("footerPlayer").children[0].children[1].children[1]
            .innerText;
    };
    tidalInfoHandler.album = function () {
        ...
        return document.getElementById("footerPlayer").children[0].children[1].children[2]
