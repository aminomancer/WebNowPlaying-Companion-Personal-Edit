...
function setupEmbedded()
{
	...
	{
		return document.getElementsByClassName("ytp-title-text").length > 0 &&
	...
	{
		var videoID = new URLSearchParams(document.getElementsByClassName('ytp-youtube-button')[0].search).get("v");
	...
	{
		if (new URLSearchParams(document.getElementsByClassName('ytp-youtube-button')[0].search).get("list") !== null) {
			...
			document.getElementsByClassName('ytp-playlist-menu-items')[0].children[Math.floor(Math.random() * document.getElementsByClassName('ytp-playlist-menu-items')[0].children.length)].click();
		} else {
	...
	youtubeEmbeddedEventHandler.previous = function()
	{
		...
		} else if (new URLSearchParams(document.getElementsByClassName('ytp-youtube-button')[0].search).get("list") !== null) {
			if (document.getElementsByClassName("html5-main-video")[0].currentTime <= 3) {
				if (playlistClicked == false && document.getElementsByClassName("ytp-playlist-menu-items")[0].children.length == 0) {
					document.getElementsByClassName("ytp-playlist-menu-button")[0].click();
					document.getElementsByClassName("ytp-playlist-menu-button")[0].click();
