...
function setup() {
  ...
  gpmInfoHandler.rating = function () {
    ...
    if (
      document.getElementsByClassName("rating-container materialThumbs")[0].children[0].children[0]
        .children[0].children[0].children.length < 2
    ) {
      return 5;
    }
    if (
      document.getElementsByClassName("rating-container materialThumbs")[0].children[1].children[0]
        .children[0].children[0].children.length < 2
    ) {
      return 1;
    }
  ...
  gpmEventHandler.rating = function (rating) {
    ...
    if (rating > 3) {
      ...
      if (
        document.getElementsByClassName("rating-container materialThumbs")[0].children[0]
      ...
      if (
        document.getElementsByClassName("rating-container materialThumbs")[0].children[1]
          .children[0].children[0].children[0].children.length == 2
      ) {
        document.getElementsByClassName("rating-container materialThumbs")[0].children[1].click();
      }
