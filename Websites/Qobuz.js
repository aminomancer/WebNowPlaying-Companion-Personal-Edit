...
function setup() {
    ...
    qobuzInfoHandler.durationString = function () {
        return document.getElementsByClassName("player__track-time-content")[0].children[2]
            .innerText;
    };
    ...
    qobuzInfoHandler.repeat = function () {
        //If repeat on
        if (
            document.getElementsByClassName("player__action-repeat")[0].className.includes("active")
        ) {
