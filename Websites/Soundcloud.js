...
function setup() {
    ...
    soundcloudInfoHandler.state = function () {
        return document.getElementsByClassName("playControl")[0].className.includes("playing")
            ? 1
            : 2;
    };
    soundcloudInfoHandler.title = function () {
        ...
        if (
            currTitle !== document.getElementsByClassName("playbackSoundBadge__titleLink")[0].title
        ) {
            lastKnownTag = "";
        }
    ...
    soundcloudInfoHandler.durationString = function () {
        return document.getElementsByClassName("playbackTimeline__duration")[0].children[1]
            .innerText;
    };
    soundcloudInfoHandler.positionString = function () {
        return document.getElementsByClassName("playbackTimeline__timePassed")[0].children[1]
            .innerText;
    };
    soundcloudInfoHandler.volume = function () {
        return (
            parseInt(document.getElementsByClassName("volume__sliderProgress")[0].style.height) /
            document.getElementsByClassName("volume__sliderBackground")[0].getBoundingClientRect()
                .height
        );
    };
