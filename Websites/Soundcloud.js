...
function setup() {
  ...
  soundcloudInfoHandler.cover = function () {
    var currCover = document.getElementsByClassName("playbackSoundBadge__avatar sc-media-image")[0]
  ...
  soundcloudInfoHandler.rating = function () {
    if (
      document.getElementsByClassName("playbackSoundBadge__like")[0].className.includes("selected")
    ) {
      return 5;
    }
    return 0;
