...
function setup() {
  ...
  soundcloudInfoHandler.readyCheck = function() {
    return !!document.getElementsByClassName("playbackSoundBadge__title")
      .length;
  };

  soundcloudInfoHandler.state = function() {
    return document
      .getElementsByClassName("playControl")[0]
  ...
  soundcloudInfoHandler.title = function() {
    ...
    return document.getElementsByClassName("playbackSoundBadge__titleLink")[0]
      .title;
  };
  soundcloudInfoHandler.artist = function() {
    return document.getElementsByClassName("playbackSoundBadge__lightLink")[0]
      .innerText;
  };
  soundcloudInfoHandler.album = function() {
    if (
      document.getElementsByClassName(
        "sc-button-play playButton sc-button sc-button-xlarge sc-button-pause"
      ).length
    ) {
      var tag = document.getElementsByClassName(
        "sc-button-play playButton sc-button sc-button-xlarge sc-button-pause"
      )[0].parentElement.parentElement.children[2].children;
      lastKnownTag = tag[tag.length - 1].innerText;
      return tag[tag.length - 1].innerText;
    }
    if (document.getElementsByClassName("queueItemView m-active").length) {
      return document
        .getElementsByClassName("queueItemView m-active")[0]
        .children[2].children[0].children[1].title.replace("From ", "");
    }
    return lastKnownTag;
  };
  soundcloudInfoHandler.cover = function() {
    var currCover = document.getElementsByClassName(
      "playbackSoundBadge__avatar sc-media-image"
    )[0].children[0].children[0].style.backgroundImage;
    return currCover
  ...
  soundcloudInfoHandler.durationString = function() {
    return document.getElementsByClassName("playbackTimeline__duration")[0]
      .children[1].innerText;
  };
  soundcloudInfoHandler.positionString = function() {
    return document.getElementsByClassName("playbackTimeline__timePassed")[0]
      .children[1].innerText;
  };
  soundcloudInfoHandler.volume = function() {
    return (
      parseInt(
        document.getElementsByClassName("volume__sliderProgress")[0].style
          .height
      ) /
      document
        .getElementsByClassName("volume__sliderBackground")[0]
  ...
  soundcloudInfoHandler.rating = function() {
    if (
      document
        .getElementsByClassName("playbackSoundBadge__like")[0]
  ...
  soundcloudInfoHandler.repeat = function() {
    if (document.getElementsByClassName("m-one").length) {
      return 2;
    }
    if (document.getElementsByClassName("m-all").length) {
      return 1;
    }
    return 0;
  };
  soundcloudInfoHandler.shuffle = function() {
    if (document.getElementsByClassName("m-shuffling").length) {
      return 1;
    }
    return 0;
  };
  ...
  soundcloudEventHandler.progress = function(progress) {
    var loc = document
      .getElementsByClassName("playbackTimeline__progressWrapper")[0]
  ...
  soundcloudEventHandler.volume = function(volume) {
    ...
    var volumeReadyTest = setInterval(function() {
      if (document.getElementsByClassName("volume expanded hover").length) {
